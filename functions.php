...
echo "<br><br>";
//doesn't keep the first and last letters in place, but that wasn't actually specified, so...?
...
acronym($str);
echo "<br>";
$suMoPostGame = "Police Locale Opérations Ultra chimères";
...
//doesn't address the values thing, but if the goal is to just write in the value name anyway, what are they for...? 
...
ucfirst(strtolower($capitalString));
